                    ...
                    <EmptyDataTemplate>
                     ...
                     <AlternatingItemTemplate>
                        <tr style="background-color:#FFF8DC;">
                            ...
                            <td>
                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("ReservationDate","{0:MMM dd,yyyy tt}") %>' />
                            </td>
                            <td>
                        ...
                        <tr style="background-color:#DCDCDC;color: #000000;">
                            ...
                            <td>
                                <asp:Label ID="ReservationDateLabel" runat="server" Text='<%# Eval("ReservationDate","{0:MMM dd,yyyy tt}") %>' />
                            </td>
                            <td>
